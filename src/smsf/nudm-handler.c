    ...
    smsf_ue_t *smsf_ue, ogs_sbi_stream_t *stream, ogs_sbi_message_t *recvmsg)
{
    ...
    if (!SmsManagementSubscriptionData) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No SmsManagementSubscriptionData", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsManagementSubscriptionData->is_mo_sms_subscribed) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No moSmsSubscribed", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsManagementSubscriptionData->is_mt_sms_subscribed) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No mtSmsSubscribed", smsf_ue->supi, NULL));
        return false;
    }
    ...
    smsf_ue_t *smsf_ue, ogs_sbi_stream_t *stream, ogs_sbi_message_t *recvmsg)
{
    ...
    if (!recvmsg->http.location) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No http.location", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (rv != OGS_OK) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "Cannot parse http.location", smsf_ue->supi, NULL));
        return OGS_ERROR;
    }
    ...
    if (!message.h.resource.component[2]) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No Subscription ID", smsf_ue->supi, NULL));
        return OGS_ERROR;
    }
    ...
    smsf_ue_t *smsf_ue, ogs_sbi_stream_t *stream, ogs_sbi_message_t *recvmsg)
{
    ...
    if (!SmsfRegistration) {
        ogs_error("[%s] No SmsfRegistration in response (status=%d)", smsf_ue->supi, recvmsg->res_status);
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No SmsfRegistration", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsfRegistration->smsf_instance_id) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No smsfInstanceId", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsfRegistration->plmn_id) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No PlmnId", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsfRegistration->plmn_id->mnc) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No PlmnId.Mnc", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsfRegistration->plmn_id->mcc) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                recvmsg, "No PlmnId.Mcc", smsf_ue->supi, NULL));
        return false;
    }
