...
void smsf_state_initial(ogs_fsm_t *s, smsf_event_t *e)
{
    ...
    OGS_FSM_TRAN(s, &smsf_state_operational);
}
...
void smsf_state_operational(ogs_fsm_t *s, smsf_event_t *e)
{
    ...
    case OGS_EVENT_SBI_CLIENT:
                ...
                CASE(OGS_SBI_RESOURCE_NAME_SMSF_3GPP_ACCESS)
                    ...
                    if (!sbi_xact) {
                        ...
                        * before receiving SBI message */
                        ogs_error("SBI transaction has already been "
                                "removed [%d]", sbi_xact_id);
                        break;
                    }
                    ...
                    smsf_ue = smsf_ue_find_by_id(sbi_object_id);
                    if (!smsf_ue) {
        ...
        CASE(OGS_SBI_SERVICE_NAME_NUDM_SDM)
            ...
            CASE(OGS_SBI_RESOURCE_NAME_SDM_SUBSCRIPTIONS)
                ...
                e->h.sbi.data =
                    ogs_sbi_stream_find_by_id(sbi_xact->assoc_stream_id);
    ...
    default:
        ogs_error("No handler for event %s", smsf_event_get_name(e));
        break;
    }
}
