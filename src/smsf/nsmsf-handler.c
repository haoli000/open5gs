        ...
        ogs_sbi_message_t *message)
{
    ...
    if (!UeSmsContextData) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No UeSmsContextData", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!UeSmsContextData->supi) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No supi", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!UeSmsContextData->amf_id) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No amfInstanceId", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!UeSmsContextData->access_type) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No access_type", smsf_ue->supi, NULL));
        return false;
    }
        ...
        ogs_sbi_message_t *message)
{
    ...
    if (!SmsRecordData) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No SmsRecordData", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsRecordData->sms_record_id) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No smsRecordId", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!SmsRecordData->sms_payload) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No smsPayload", smsf_ue->supi, NULL));
        return false;
    }
    ...
    if (!sms_payload || !sms_payload->content_id) {
        ...
        ogs_assert(true ==
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                message, "No smsPayload and/or content_id", smsf_ue->supi, NULL));
        return false;
    }
    ...
    case SMSF_SERVICE_MESSAGE_TYPE_CP_DATA:
        ...
        if (sms_payload_buf->len != cp_data->cp_user_data_length) {
            ...
            ogs_sbi_server_send_error(stream, OGS_SBI_HTTP_STATUS_BAD_REQUEST,
                    message, "SMS_PAYLOAD_ERROR", smsf_ue->supi, NULL);
            return false;
        }
